...
export default function PageHeader() {
  return (
    <header className="mb-6 sm:mb-8" data-testid="preferences-header">
      <h1 className="text-2xl sm:text-3xl font-bold tracking-tight" data-testid="preferences-heading">Welcome to VibeTravels!</h1>
      <p className="text-muted-foreground mt-2 text-base sm:text-lg leading-relaxed" data-testid="preferences-description">
